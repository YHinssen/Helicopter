...
S_FP = 2.5; %Fuselage equivalent plate area
...
%% Extra calculations
% Another calculation was initialized as well, in order to make use of the
% full system equations instead of just the single equation for the
% eigenvalues of the phugoid motion. However, due to time concerns, this
% was not completed before the deadline. The work can be seen below
